...
.multipleChoice(
    ...
    subsectionId: "6c",
    difficulty: .medium,
    question: "Which drug in this subsection is the classic oral fluoroquinolone linked to UTIs and Pseudomonas coverage rather than the \u{201C}respiratory fluoroquinolone\u{201D} label?",
    options: ["Ciprofloxacin", "Levofloxacin", "Azithromycin", "Clarithromycin", "Doxycycline"],
    answer: "Ciprofloxacin",
...
.multipleChoice(
    ...
    subsectionId: "6c",
    difficulty: .medium,
    question: "Which drug in this subsection is most commonly remembered as the \u{201C}respiratory fluoroquinolone\u{201D} and is often chosen when a fluoroquinolone is needed for community-acquired pneumonia?",
    options: ["Levofloxacin", "Ciprofloxacin", "Azithromycin", "Clarithromycin", "Doxycycline"],
    answer: "Levofloxacin",
...
.multipleChoice(
    ...
    subsectionId: "6c",
    difficulty: .medium,
    question: "A patient says, \u{201C}This antibiotic feels like it burns in my chest when I take it before bed.\u{201D} Which drug from this subsection is the classic culprit because of esophageal irritation and ulceration risk?",
    options: ["Doxycycline", "Azithromycin", "Clarithromycin", "Levofloxacin", "Ciprofloxacin"],
    answer: "Doxycycline",
...
.multipleChoice(
    ...
    subsectionId: "6c",
    difficulty: .medium,
    question: "Which drug in this subsection is most associated with dysgeusia or a \u{201C}metallic/taste-perversion\u{201D} complaint?",
    options: ["Clarithromycin", "Azithromycin", "Doxycycline", "Levofloxacin", "Ciprofloxacin"],
    answer: "Clarithromycin",
...
.multipleChoice(
    ...
    subsectionId: "6c",
    difficulty: .medium,
    question: "Which drug in this subsection is most strongly associated with the familiar adult 5-day \u{201C}Z-Pack\u{201D} pattern of 500 mg on day 1 followed by 250 mg daily on days 2 through 5?",
    options: ["Azithromycin", "Clarithromycin", "Doxycycline", "Levofloxacin", "Ciprofloxacin"],
    answer: "Azithromycin",
...
.multipleChoice(
    ...
    subsectionId: "6c",
    difficulty: .medium,
    question: "An older patient with baseline long-QT syndrome and bradyarrhythmia asks whether a Z-Pack is automatically safe because it is \u{201C}common.\u{201D} Which risk is the key reason for caution with azithromycin?",
    ...
    explanation: "Azithromycin is commonly prescribed, but it still carries an important QT-prolongation warning. \u{201C}Common\u{201D} does not mean free of serious risk.",
    objective: .adverseEffect,
    relatedDrugIds: ["d106"],
...
.multipleChoice(
    ...
    subsectionId: "6c",
    difficulty: .medium,
    question: "A patient with acne says, \u{201C}I usually take my medicine right before I lie down.\u{201D} Which drug from this subsection should trigger the strongest counseling to take it with a full glass of water and stay upright?",
    options: ["Doxycycline", "Azithromycin", "Clarithromycin", "Levofloxacin", "Ciprofloxacin"],
    answer: "Doxycycline",
