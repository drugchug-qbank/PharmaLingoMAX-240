...
// 2) In DrugDataService.populateCuratedBank(_:), ensure subsection 3c exists, then append:
//
...
// - relatedDrugIds use the uploaded repo IDs: d51 (Empagliflozin), d52 (Dapagliflozin).
