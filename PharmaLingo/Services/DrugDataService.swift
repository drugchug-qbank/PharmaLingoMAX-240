...
struct DrugDataService {
    ...
    private init() {
        let m1Sub1a = Subsection(
            ...
            iconName: "heart.fill",
            drugs: [
                Drug(id: "d1", genericName: "Lisinopril", brandName: "Zestril/Prinivil", drugClass: "ACE Inhibitor", suffix: "-pril", indications: ["HTN", "HF", "Post-MI", "Diabetic nephropathy"], sideEffects: ["Dry cough", "Hyperkalemia", "Angioedema", "Dizziness"], clinicalPearls: ["Most prescribed ACE inhibitor", "Monitor K+ and SCr"], blackBoxWarnings: ["Contraindicated in pregnancy (fetal toxicity)"], majorContraindications: ["Pregnancy", "History of angioedema", "Bilateral renal artery stenosis", "Concomitant use with aliskiren in diabetics"], monitoring: ["Serum potassium", "Serum creatinine/BUN", "Blood pressure"], commonDosing: [DoseFact(context: "HTN (adult start)", dose: "10 mg PO daily"), DoseFact(context: "HTN (usual range)", dose: "20–40 mg/day"), DoseFact(context: "HTN (max)", dose: "80 mg/day")]),
                Drug(id: "d2", genericName: "Enalapril", brandName: "Vasotec", drugClass: "ACE Inhibitor", suffix: "-pril", indications: ["HTN", "HF"], sideEffects: ["Dry cough", "Hyperkalemia", "Angioedema"], clinicalPearls: ["Available as IV (enalaprilat)", "Prodrug - converted to enalaprilat"], blackBoxWarnings: ["Contraindicated in pregnancy (fetal toxicity)"], majorContraindications: ["Pregnancy", "History of angioedema", "Bilateral renal artery stenosis"], monitoring: ["Serum potassium", "Serum creatinine/BUN", "Blood pressure"], commonDosing: [DoseFact(context: "HTN (adult start)", dose: "5 mg PO daily"), DoseFact(context: "HTN (usual range)", dose: "10–40 mg/day")]),
                Drug(id: "d3", genericName: "Ramipril", brandName: "Altace", drugClass: "ACE Inhibitor", suffix: "-pril", indications: ["HTN", "HF", "CV risk reduction"], sideEffects: ["Dry cough", "Hyperkalemia"], clinicalPearls: ["CV risk reduction in high-risk patients", "Used post-MI"], blackBoxWarnings: ["Contraindicated in pregnancy (fetal toxicity)"], majorContraindications: ["Pregnancy", "History of angioedema", "Bilateral renal artery stenosis"], monitoring: ["Serum potassium", "Serum creatinine/BUN", "Blood pressure"], commonDosing: [DoseFact(context: "HTN (adult start)", dose: "2.5 mg PO daily"), DoseFact(context: "HTN (usual range)", dose: "2.5–20 mg/day")]),
                Drug(id: "d4", genericName: "Benazepril", brandName: "Lotensin", drugClass: "ACE Inhibitor", suffix: "-pril", indications: ["HTN"], sideEffects: ["Dry cough", "Hyperkalemia"], clinicalPearls: ["Often combined with amlodipine (Lotrel)"], blackBoxWarnings: ["Contraindicated in pregnancy (fetal toxicity)"], majorContraindications: ["Pregnancy", "History of angioedema"], monitoring: ["Serum potassium", "Serum creatinine/BUN"], commonDosing: [DoseFact(context: "HTN (adult start)", dose: "10 mg PO daily"), DoseFact(context: "HTN (usual range)", dose: "20–40 mg/day")]),
                Drug(id: "d5", genericName: "Losartan", brandName: "Cozaar", drugClass: "ARB", suffix: "-sartan", indications: ["HTN", "Diabetic nephropathy", "Stroke prevention"], sideEffects: ["Hyperkalemia", "Dizziness"], clinicalPearls: ["Uricosuric effect (lowers uric acid)", "First ARB approved"], blackBoxWarnings: ["Contraindicated in pregnancy (fetal toxicity)"], majorContraindications: ["Pregnancy", "Concomitant use with aliskiren in diabetics"], monitoring: ["Serum potassium", "Serum creatinine/BUN", "Blood pressure"], commonDosing: [DoseFact(context: "HTN (adult start)", dose: "50 mg PO daily"), DoseFact(context: "HTN (max)", dose: "100 mg/day"), DoseFact(context: "HTN (volume depleted start)", dose: "25 mg PO daily")]),
                Drug(id: "d6", genericName: "Valsartan", brandName: "Diovan", drugClass: "ARB", suffix: "-sartan", indications: ["HTN", "HF", "Post-MI"], sideEffects: ["Hyperkalemia", "Hypotension"], clinicalPearls: ["Component of Entresto (sacubitril/valsartan)", "No prodrug conversion needed"], blackBoxWarnings: ["Contraindicated in pregnancy (fetal toxicity)"], majorContraindications: ["Pregnancy", "Concomitant use with aliskiren in diabetics"], monitoring: ["Serum potassium", "Serum creatinine/BUN", "Blood pressure"], commonDosing: [DoseFact(context: "HTN (adult start)", dose: "80–160 mg PO daily"), DoseFact(context: "HTN (usual range)", dose: "80–320 mg/day")]),
                Drug(id: "d7", genericName: "Irbesartan", brandName: "Avapro", drugClass: "ARB", suffix: "-sartan", indications: ["HTN", "Diabetic nephropathy"], sideEffects: ["Hyperkalemia", "Dizziness"], clinicalPearls: ["Strong evidence for nephroprotection in T2DM"], blackBoxWarnings: ["Contraindicated in pregnancy (fetal toxicity)"], majorContraindications: ["Pregnancy"], monitoring: ["Serum potassium", "Serum creatinine/BUN"], commonDosing: [DoseFact(context: "HTN (adult start)", dose: "150 mg PO daily"), DoseFact(context: "HTN (max)", dose: "300 mg/day")]),
                Drug(id: "d8", genericName: "Olmesartan", brandName: "Benicar", drugClass: "ARB", suffix: "-sartan", indications: ["HTN"], sideEffects: ["Hyperkalemia", "Sprue-like enteropathy"], clinicalPearls: ["Unique side effect: sprue-like enteropathy (diarrhea, weight loss)"], blackBoxWarnings: ["Contraindicated in pregnancy (fetal toxicity)"], majorContraindications: ["Pregnancy"], monitoring: ["Serum potassium", "Serum creatinine/BUN"], commonDosing: [DoseFact(context: "HTN (adult start)", dose: "20 mg PO daily"), DoseFact(context: "HTN (max)", dose: "40 mg/day")]),
            ],
            isMasteryQuiz: false,
            learningSlides: [
        ...
        let m1Sub1c = Subsection(
            ...
            drugs: [
                Drug(id: "d14", genericName: "Metoprolol succinate", brandName: "Toprol XL", drugClass: "Selective Beta-1 Blocker", suffix: "-olol", indications: ["HTN", "HF (HFrEF)", "Angina"], sideEffects: ["Bradycardia", "Fatigue", "Depression"], clinicalPearls: ["Succinate = extended release for HF"], blackBoxWarnings: ["Do not abruptly discontinue (risk of rebound angina/MI)"], majorContraindications: ["Severe bradycardia", "Decompensated HF", "2nd/3rd degree heart block", "Cardiogenic shock"], monitoring: ["Heart rate", "Blood pressure"]),
                Drug(id: "d15", genericName: "Metoprolol tartrate", brandName: "Lopressor", drugClass: "Selective Beta-1 Blocker", suffix: "-olol", indications: ["HTN", "Acute MI", "Rate control"], sideEffects: ["Bradycardia", "Fatigue"], clinicalPearls: ["Tartrate = immediate release, BID dosing"], blackBoxWarnings: ["Do not abruptly discontinue (risk of rebound angina/MI)"], majorContraindications: ["Severe bradycardia", "Decompensated HF", "2nd/3rd degree heart block"], monitoring: ["Heart rate", "Blood pressure"]),
                Drug(id: "d16", genericName: "Carvedilol", brandName: "Coreg", drugClass: "Non-selective Beta + Alpha Blocker", suffix: "-olol", indications: ["HF (HFrEF)", "HTN"], sideEffects: ["Bradycardia", "Hypotension", "Dizziness"], clinicalPearls: ["Alpha + Beta blocker", "Take with food"], blackBoxWarnings: ["Do not abruptly discontinue"], majorContraindications: ["Severe bradycardia", "Decompensated HF", "2nd/3rd degree heart block", "Bronchial asthma"], monitoring: ["Heart rate", "Blood pressure"]),
                Drug(id: "d17", genericName: "Atenolol", brandName: "Tenormin", drugClass: "Selective Beta-1 Blocker", suffix: "-olol", indications: ["HTN", "Angina"], sideEffects: ["Bradycardia", "Fatigue"], clinicalPearls: ["Renally eliminated"], blackBoxWarnings: ["Do not abruptly discontinue"], majorContraindications: ["Severe bradycardia", "2nd/3rd degree heart block"], monitoring: ["Heart rate", "Blood pressure", "Renal function"]),
                Drug(id: "d18", genericName: "Propranolol", brandName: "Inderal", drugClass: "Non-selective Beta Blocker", suffix: "-olol", indications: ["HTN", "Tremor", "Migraine prophylaxis"], sideEffects: ["Bradycardia", "Bronchospasm", "Mask hypoglycemia"], clinicalPearls: ["Non-selective: blocks B1 and B2", "Avoid in asthma/COPD"], blackBoxWarnings: ["Do not abruptly discontinue"], majorContraindications: ["Asthma", "COPD with bronchospasm", "Severe bradycardia", "2nd/3rd degree heart block"], monitoring: ["Heart rate", "Blood pressure", "Blood glucose in diabetics"]),
                Drug(id: "d19", genericName: "Bisoprolol", brandName: "Zebeta", drugClass: "Selective Beta-1 Blocker", suffix: "-olol", indications: ["HTN", "HF (HFrEF)"], sideEffects: ["Bradycardia", "Fatigue"], clinicalPearls: ["Most beta-1 selective"], blackBoxWarnings: ["Do not abruptly discontinue"], majorContraindications: ["Severe bradycardia", "Decompensated HF", "2nd/3rd degree heart block"], monitoring: ["Heart rate", "Blood pressure"]),
            ],
            isMasteryQuiz: false,
            learningSlides: [
